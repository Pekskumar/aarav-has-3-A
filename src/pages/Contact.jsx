...
const Contact = () => {
	return (
       ...
       btnname="Learn More"
       imgsrc="https://images.pexels.com/photos/789822/pexels-photo-789822.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
        />
	...
	<div class="contact">
		<div class="other">
			<div class="info">
				...
				<h3>Email</h3>
				<div class="svg-wrap">
					<a href="mailto:prakash.montu_92@live.com"><i class="fas fa-envelope"></i> prakash.montu_92@live.com</a>
				</div>
				<h3>Phone</h3>
				<div class="svg-wrap">
					<a href="tel:+91 8866808798"><i class="fas fa-phone-alt"></i> +91 8866808798</a>
				</div>
				<h3>Connect</h3>
				<div class="svg-wrap">
